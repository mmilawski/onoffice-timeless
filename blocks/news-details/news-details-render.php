...
?>
<section <?php oo_block_id($block); ?> class="c-news-details o-section">
    <div class="c-news-details__container o-container">
        <div class="c-news-details__row o-row">
            <div class="c-news-details__content o-col-12 o-col-lg-6">
                <?php if (
                    ($is_date && !empty($date)) ||
                    ($is_categories && !empty($categories))
                ) { ?>
                    <div class="c-news-details__labels">
            ...
            <?php if (!empty($image['url'])) { ?>
                <?php oo_get_template('components', '', 'component-image', [
                    'image' => $image,
                    'picture_class' =>
                        'c-news-details__picture o-picture o-col-12 o-col-lg-5 u-offset-lg-1',
