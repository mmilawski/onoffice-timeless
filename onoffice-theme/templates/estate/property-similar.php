...
if ($totalSimilar > 0): ?>
    <div class="c-property-details__similar-wrapper">
        ...
        <div id="outerslider" class="c-property-details__similar-slider --tile c-slider --is-properties-similar-slider splide" data-splide='{"perPage":1,"perMove":1,"gap":32,"pagination":false,"arrows":false,"page":false,"snap":true,"lazyLoad":"nearby","mediaQuery":"min","breakpoints":{"992":{"perPage":2},"1400":{"perPage":3}}}'>
            ...
            <div class="c-slider__navigation splide__navigation --is-properties-slider o-container">
                ...
                <div class="c-slider__arrows splide__arrows">
                    <button class="c-slider__arrow --prev splide__arrow splide__arrow--prev" aria-label="<?php esc_attr_e(
                        'Vorheriges',
                        'oo_theme',
                    ); ?>">
                    ...
                    <button class="c-slider__arrow --next splide__arrow splide__arrow--next" aria-label="<?php esc_attr_e(
                        'Nächstes',
                        'oo_theme',
                    ); ?>">
                        <span class="c-slider__arrow-text u-screen-reader-only">
